...
const DashboardWrapper: FC = () => {
  ...
  return <>
    ...
    <div className='row g-5 g-xl-10 d-flex align-items-stretch'>
      {/* begin::Col 1 */}
      <div className='col-md-3 col-lg-3 col-xl-3 col-xxl-3 mb-md-4 text-white'>
      ...
      <div className='col-md-3 col-lg-3 col-xl-3 col-xxl-3 mb-md-4 text-white'>
       ...
       {/* begin::Col 4 */}
       <div className='col-md-3 col-lg-3 col-xl-3 col-xxl-3 mb-md-4 text-white'>
        <a className="text-white" data-bs-toggle="collapse" href="#collapseExample4" role="button" aria-expanded="false" aria-controls="collapseExample4" data-bs-target="#collapseExample4">
          <CardsWidget21
            className='h-md-30 mb-1 mb-xl-1 p-3 h-100'
            color='#254785'
            img={toAbsoluteUrl('/media/patterns/vector-1.png')}
            title='View All EXT & GSM Numbers'
