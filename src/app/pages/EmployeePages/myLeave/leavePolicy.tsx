...
<h1 className="text-primary mb-10"><i className="bi bi-shield-lock fs-2hx me-3 svg-icon-muted text-primary"></i>  {/* icon  */} Leave Policy</h1>
...
{/* <div className="d-grid gap-2 d-md-flex justify-content-md-end">
        <button className="btn btn-sm" type="button" style={{background:"#36454F" , color:"#fff"}}><i className="bi bi-box-arrow-down fs-1hx px-3 svg-icon-muted text-white"></i>Save</button>
  </div> */}
