     ...
     <div className='card mb-2 mb-xl-5'>
      ...
      >
         <IconButton
                ...
                // onClick={() => {}}
              >
                <i className="bi bi-person-plus-fill fs-2x px-5 svg-icon-muted text-warning"></i>  {/* icon  */}

                 <div className='card-title m-0'>
                  <h3 className='fw-bolder m-0 text-white'>Register New Employee </h3>
                </div>
        </IconButton>
          ...
          <div className='card-body p-9'>
            ...
            <div className='row'>
              ...
              <div className='col-lg-20'>
                ...
                <label className="text-primary" htmlFor="photo">Click here to Choose photo!</label>
            ...
            <div className='row mb-1'>
              ...
              <div className='col-lg-3 fv-row'>
                <input
                      ...
                      className='form-control form-control-lg form-control-solid mb-3 mb-lg-0 border border-primary'
                      placeholder=''
                      {...formik.getFieldProps('InternalJobTitle')}
                    />
              </div>
            </div>
...
<div className='add-Benefits'>   
  <div  className="d-flex justify-content-start pb-1">
            <a className="text-white" data-bs-toggle="collapse" href="#collapseExample1" role="button" aria-expanded="false" aria-controls="collapseExample1"> 
                <button type="button" className="btn btn-primary btn-lg">+ Add Benefits</button>
            </a> 
                </div>
...
<div className='card mb-2 mb-xl-5'>
      <div
        ...
        role='button'
        data-bs-toggle='collapse'
        data-bs-target='#add_family_members'
        aria-expanded='true'
        aria-controls='add_family_members'
        style={{background: "#7d96c9"}}
      >
         <IconButton
                className='px-2'
                // onClick={() => {}}
              >
                <i className="bi bi-people-fill fs-2x px-5 svg-icon-muted text-warning"></i>  {/* icon  */}
                 ...
                 <div className='card-title m-0'>
                  <h3 className='fw-bolder m-0 text-white'>Add Employee Family Members</h3>
                </div>
        </IconButton>
...
<div id='add_family_members' className='collapse'>
...
<label className='col-lg-3 col-form-label fw-bold fs-6 text-primary'>Enter Members Number: </label>
<div className='col-lg-2 fv-row px-3'>
<input
            type='number'
            className='form-control form-control-lg form-control-solid mb-3 mb-lg-0 border border-primary'
            placeholder=''
...
<p className="fw-bold mb-5"><span className="badge badge-primary fs-6"><i className="bi bi-person text-white fs-3 me-3"></i> no. 1</span></p>
      ...
      <div className='row mb-1'>
            ...
            <div className='card-footer d-flex justify-content-end py-6 px-9'>
            <button type='submit' className='btn btn-primary' disabled={loading}>
              {!loading && 'Register Family Member'}
              {loading && (
                <span className='indicator-progress' style={{display: 'block'}}>
                  Please wait...{' '}
                  <span className='spinner-border spinner-border-sm align-middle ms-2'></span>
 ...
 {/* add / edit Employee Responsibilities */}
 ...
 <div className='card mb-2 mb-xl-5'>
      <div
        ...
        role='button'
        data-bs-toggle='collapse'
        data-bs-target='#add_employee_Job_Description'
        aria-expanded='true'
        aria-controls='add_employee_Job_Description'
      ...
      >
         <IconButton
              ...
              >
               <i className="bi bi-people-fill fs-2x px-5 svg-icon-muted text-warning"></i>  {/* icon  */}
                <div className='card-title m-0'>
                  <h3 className='fw-bolder m-0 text-white'>Add / Edit Employee Job  Description / Responsibilities</h3>
                </div>
        </IconButton>
      ...
      <div id='add_employee_Job_Description' className='collapse'>
        <form onSubmit={formik.handleSubmit} noValidate className='form'>
          <div className='card-body p-9'>
          ...
          <div className='col-lg-5 fv-row mb-5 d-flex'>
            ...
            <div className="mb-3">
            <textarea className="form-control bg-body-secondary fw-bold" id="exampleFormControlTextarea1"> 
              - Address employee concerns, Forecast workforce needs and grievances and Foster a positive work environment.
              
              - Develop and implement performance appraisal systems.
              
              - Administer employee benefits and compensation.
              
              - Ensure adherence to labor laws and regulations and Develop succession plans for key roles.
