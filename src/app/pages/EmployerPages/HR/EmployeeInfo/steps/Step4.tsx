    ...
    <div className='w-100'>
     <div className='pb-10 pb-lg-15'>
      ...
      <div className="form-group mb-5">
        <label className="fs-8 text-danger mb-2 mx-2">Select Number of Members:</label>
        <div className="input-group">
          <div className="input-group-prepend">
            <button className="btn btn-secondary rounded-start rounded-end-0 btn-sm" type="button">
              <i className="bi bi-person-plus-fill text-primary fs-4"></i>
            </button>
          </div>
          <select className="form-select form-select-solid border fs-8 bg-body-secondary form-select-sm" aria-label="Select example">
...
<p className="fw-bold mb-5 mt-5"><span className="badge badge-primary fs-9"><i className="bi bi-person text-white fs-5 me-3"></i> no. 1</span></p>
...
<p className="fw-bold mb-5 mt-5"><span className="badge badge-primary fs-9"><i className="bi bi-person text-white fs-5 me-3"></i> no. 2</span></p>
