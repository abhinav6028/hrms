...
const BankGuaranteeTable = () => {
  const [recievedData,setData] = useState<BankGuaranteeDetails[]>(data)
  const columns = useMemo<MRT_ColumnDef<BankGuaranteeDetails>[]>(
    () => [
    // {
    ...
    //     columns: [
            {
                accessorFn: (row) => `${row.projectName}`, //accessorFn used to join multiple data into a single cell
                id: 'name',
                header: 'Project Name',
                size: 250,
    ...
    //     columns: [
            ...
            },
            {
                ...
                header: 'Percentage of Completion',
                ...
                Cell: ({cell,row}) => {
                    ...
                    // const nowdiff = differenceInDays(startDate,nowDate)
                    return (
                        <div className='d-flex flex-column w-100 me-2'>
                            <div className='d-flex flex-stack mb-2'>
                                <span className='me-2 fs-7 fw-semibold'>{cell.getValue<number>()}%</span>
                            </div>
                            <div className='progress h-6px w-100'>
                                <div
                                    className={`progress-bar ${cell.getValue<number>()>75 ?'bg-success' 
                                        :(cell.getValue<number>()>25 ?'bg-warning' :'bg-danger')}`}
                                    role='progressbar'
                                    style={{width: `${cell.getValue<number>()}%`}}
                                ></div>
                            </div>
                        </div>
                    )
