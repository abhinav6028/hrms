...
const PayrollTable = () => {
  const [recievedData,setData] = useState<PayrollDetails[]>(data)
  ...
  const columns = useMemo<MRT_ColumnDef<PayrollDetails>[]>(
    () => [
    // {
    ...
    //     columns: [
            ...
            },
            {
                ...
                <Box
                    ...
                    sx={(theme) => ({
                    backgroundColor:
                        cell.getValue<number>() < 300
                        ? theme.palette.error.dark
                        : cell.getValue<number>() >= 300 &&
                            cell.getValue<number>() < 600
